    ...
    return (
        <div className="h-screen overflow-y-auto bg-[#121212] text-white">
            <div className="mx-auto my-8 flex w-full max-w-sm flex-col px-4">
                ...
                <form onSubmit={handleSubmit} className="mx-auto flex w-full max-w-sm flex-col px-4">
                    <Input
                        label="Email"
                        type="email"
                        value={email}
                    ...
                    <Button type="submit" className="px-4 py-3">Sign in with Email</Button>
                </form>
                <Link to="/register" className="px-4">Create Account</Link>
            </div>
        </div>
    );
}
